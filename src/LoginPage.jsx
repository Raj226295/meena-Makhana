...
export default function LoginPage(){
 ...
 const submit=e=>{e.preventDefault();setNotice('Login service will be available soon.')}
 return <><StoreNavbar/><main className="login-page">
  ...
  <section className="login-card" aria-labelledby="login-title">
   ...
   <form onSubmit={submit}>
    <label className="login-field"><Icon name="mail"/><input type="text" required autoComplete="username" placeholder="Email or Mobile Number" aria-label="Email or mobile number"/></label>
